...
c.execute('CREATE TABLE IF NOT EXISTS "CRIME_DATA_TABLE" (crime_id STRING, month STRING, reported_by STRING, fall_within STRING, longitude FLOAT, latitude FLOAT, location STRING, lsoa_code STRING, lsoa_name STRING, crime_type STRING, last_outcome STRING)')
